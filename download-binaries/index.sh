...
# todo: 404
download 'https://github.com/GyanD/codexffmpeg/releases/download/7.0.2/ffmpeg-7.0.2-essentials_build.7z' win32-x64.7z
echo '  extracting'
tmpdir=$(mktemp -d)
...
download $(curl 'https://evermeet.cx/ffmpeg/info/ffmpeg/7.0.2' -fsS| jq -rc '.download.zip.url') ffmpeg-darwin-x64.zip
download $(curl 'https://evermeet.cx/ffmpeg/info/ffprobe/7.0.2' -fsS| jq -rc '.download.zip.url') ffprobe-darwin-x64.zip
echo '  extracting'
...
curl -fsSL 'https://git.ffmpeg.org/gitweb/ffmpeg.git/blob_plain/n7.0.2:/LICENSE.md'  -o ../bin/darwin-arm64.LICENSE
curl -fsSL 'https://git.ffmpeg.org/gitweb/ffmpeg.git/blob_plain/n7.0.2:/README.md'  -o ../bin/darwin-arm64.README
...
curl -fsSL 'https://git.ffmpeg.org/gitweb/ffmpeg.git/blob_plain/n7.0.2:/README.md' -o ../bin/freebsd-x64.README
